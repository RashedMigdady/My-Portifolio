...
export const SideBar = ()=>{
    ...
    return(<>
        ...
        <div  className="sideBarComponent">
            ...
            <a href="https://rashedmigdady.github.io/My-Portifolio/" style={{textDecoration:"none" }} ><h1 className="title"> <p style={{ letterSpacing: "7px" , color:"white",marginTop:"100px"}}>RASHED</p></h1></a>
